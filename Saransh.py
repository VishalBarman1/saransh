...
st.subheader('Final Year Project For Group 14')


image = Image.open('GIMT.jpg')
st.sidebar.image(image, use_column_width=True)
st.sidebar.markdown('<center> <h1>Saransh</h1></center>',unsafe_allow_html=True)
st.sidebar.markdown('[![]\
					(https://img.shields.io/badge/College-site-brightgreen)]\
					(http://www.gimt-guwahati.ac.in/)')

st.sidebar.markdown('<center>An efficient and advanced summarizer which can summarize any News Articles, Wikipedia Articles, YouTube Videos and any lenghty Textual Data</center>',unsafe_allow_html=True)
st.sidebar.markdown('<h4>Made By:<br/><br/>Vishal Barman(170310007055)<br/>Nawaz Khan Choudhury(170310007033)<br/>Mustafizur Rahman(170310007031)</h4>',unsafe_allow_html=True)
st.sidebar.markdown('<center><h2>Under the valuable guidance of <br/><br/>Dr. Utpal Barman,<br/>Assistant Professor,<br/>CSE,GIMT, Ghy</h2></center>',unsafe_allow_html=True)
